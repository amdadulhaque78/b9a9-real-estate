    ...
    return (
        <div className="navbar bg-base-100 shadow-md container mx-auto">
            <div className="navbar-start">
                ...
                <a className="lg:text-2xl lg:font-bold text-base font-semibold text-[#69b99d]">Skyline Residence</a>
            </div>
                ...
                {/* <div className="dropdown dropdown-end mr-3">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                        <div className="w-10 rounded-full">
                            {
                                user ? <img alt="Tailwind CSS Navbar component" src={user.photoURL} /> : <img alt="Tailwind CSS Navbar component" src={user1} />
                            }
                        </div>
                    </div>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
