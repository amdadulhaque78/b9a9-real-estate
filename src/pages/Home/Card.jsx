    ...
    return (
        <div className="max-w-sm mx-auto rounded overflow-hidden shadow-lg p-2 ml-2 mr-2">
            ...
            <div className="px-6 py-2">
                ...
                {/* <div className="my-2 flex justify-between items-center">
                                <p className="text-gray-700 text-base"><span className="text-base font-semibold">Location:</span> location</p>
                                <p className="text-gray-700 text-base"><span className="text-base font-semibold">Facilities:</span> facilities.join</p>
                            </div> */}
            </div>
            {/* <div className="px-6">
                            <p className="text-gray-700 text-base"><span className="text-base font-semibold">Segment Name:</span> location</p>
                            <p className="text-gray-700 text-base"><span className="text-base font-semibold">Status:</span> location</p>
                        </div> */}
